...
const layer_config_t layer_configs[NLAYERS] = 
{
    [LAYER_BASE] =
    {
        ...
        .kcfg = {
            ...
            {ON_NOWT,                  ON_NOWT,                  ON_PRESS(ESCAPE),             ON_TAP_HOLD(BACKSPACE, LAYER_NAV), ON_TAP_HOLD(DELETE, LAYER_MOUSE), ON_PRESS(ENTER), ON_TAP_HOLD(SPACE, LAYER_NUM),     ON_TAP_HOLD(TAB, LAYER_FUN),    ON_NOWT,                   ON_NOWT},
        }
    },
    [LAYER_NAV] =
    {
        ...
        .kcfg = {
            ...
            {ON_NOWT,            ON_NOWT,            ON_PRESS(ESCAPE),       ON_TAP_HOLD(BACKSPACE, LAYER_NAV), ON_TAP_HOLD(DELETE, LAYER_MOUSE),  ON_PRESS(ENTER),     ON_PRESS(SPACE),      ON_PRESS(TAB),        ON_NOWT,            ON_NOWT},
        },
    },
    [LAYER_MOUSE] = 
    {
        ...
        .kcfg = {
            ...
            {ON_NOWT,            ON_NOWT,            ON_PRESS(ESCAPE),       ON_TAP_HOLD(BACKSPACE, LAYER_NAV), ON_TAP_HOLD(DELETE, LAYER_MOUSE),  ON_PRESS(MOUSE_BUTTON_LEFT), ON_PRESS(MOUSE_BUTTON_MIDDLE), ON_PRESS(MOUSE_BUTTON_RIGHT),  ON_NOWT,                     ON_NOWT},
        },
    },
    [LAYER_NUM] =
    {
        ...
        .kcfg = {
            ...
            {ON_PRESS(SEMICOLON),    ON_PRESS(4), ON_PRESS(5),      ON_PRESS(6), ON_PRESS(EQUAL),           ON_NOWT,         ON_PRESS(SHIFT_LEFT),              ON_PRESS(CONTROL_LEFT),         ON_PRESS(ALT_LEFT), ON_PRESS(GUI_LEFT)},
            {ON_PRESS(GRAVE),        ON_PRESS(1), ON_PRESS(2),      ON_PRESS(3), ON_PRESS(BACKSLASH),       ON_NOWT,         ON_NOWT,                           ON_NOWT,                        ON_NOWT,            ON_NOWT},
            {ON_NOWT,                ON_NOWT,     ON_PRESS(PERIOD), ON_PRESS(0), ON_PRESS(MINUS),           ON_PRESS(ENTER), ON_TAP_HOLD(SPACE, LAYER_NUM),     ON_TAP_HOLD(TAB, LAYER_FUN),    ON_NOWT,            ON_NOWT},
        },
    },
    [LAYER_SYM] = 
    {
    ...
    [LAYER_FUN] =
    {
        ...
        .kcfg = {
            ...
            {ON_NOWT,       ON_NOWT,      ON_PRESS(APPLICATION), ON_PRESS(BACKSPACE), ON_PRESS(DELETE),       ON_TAP_HOLD(ENTER, LAYER_SYM), ON_TAP_HOLD(SPACE, LAYER_NUM), ON_TAP_HOLD(TAB, LAYER_FUN), ON_NOWT,            ON_NOWT},
        },
    },
};
