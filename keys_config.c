...
const layer_config_t layer_configs[NLAYERS] = 
{
    [LAYER_BASE] =
    {
        ...
        .kcfg = {
            ...
            {ON_NOWT,                  ON_NOWT,                  ON_PRESS(ESCAPE),             ON_TAP_HOLD(SPACE, LAYER_NAV), ON_TAP_HOLD(TAB, LAYER_MOUSE), ON_PRESS(ENTER),          ON_TAP_HOLD(BACKSPACE, LAYER_NUM), ON_TAP_HOLD(DELETE, LAYER_FUN), ON_NOWT,                   ON_NOWT},
        }
    },
    [LAYER_NAV] =
    {
        ...
        .kcfg = {
            ...
            {ON_NOWT,            ON_NOWT,            ON_PRESS(ESCAPE),       ON_TAP_HOLD(SPACE, LAYER_NAV), ON_TAP_HOLD(TAB, LAYER_MOUSE),  ON_PRESS(ENTER),     ON_PRESS(BACKSPACE),  ON_PRESS(DELETE),     ON_NOWT,            ON_NOWT},
        },
    },
    [LAYER_MOUSE] = 
    {
        ...
        .kcfg = {
            ...
            {ON_NOWT,            ON_NOWT,            ON_PRESS(ESCAPE),       ON_TAP_HOLD(SPACE, LAYER_NAV), ON_TAP_HOLD(TAB, LAYER_MOUSE),  ON_PRESS(MOUSE_BUTTON_LEFT), ON_PRESS(MOUSE_BUTTON_MIDDLE), ON_PRESS(MOUSE_BUTTON_RIGHT),  ON_NOWT,                     ON_NOWT},
        },
    },
    [LAYER_NUM] =
    {
        ...
        .kcfg = {
            ...
            {ON_NOWT,                ON_NOWT,     ON_PRESS(PERIOD), ON_PRESS(0), ON_PRESS(MINUS),           ON_PRESS(ENTER), ON_TAP_HOLD(BACKSPACE, LAYER_NUM), ON_TAP_HOLD(DELETE, LAYER_FUN), ON_NOWT,            ON_NOWT},
        },
    },
    [LAYER_SYM] = 
    {
    ...
    [LAYER_FUN] =
    {
        ...
        .kcfg = {
            ...
            {ON_NOWT,       ON_NOWT,      ON_PRESS(APPLICATION), ON_PRESS(SPACE), ON_PRESS(TAB),            ON_TAP_HOLD(ENTER, LAYER_SYM), ON_TAP_HOLD(BACKSPACE, LAYER_NUM), ON_TAP_HOLD(DELETE, LAYER_FUN), ON_NOWT,            ON_NOWT},
        },
    },
};
